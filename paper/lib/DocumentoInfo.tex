...
\titulo{Features Analyzer}
\subtitulo{Desenvolvimento de uma plataforma de Análise e Visualização de Dados}
\tipotrabalho{Monografia (bacharel em Sistema de Informação) }
\autor{Zaú Júlio Araújo Galvão}
\orientador{Ms. Luiz Paulo de Assis Barbosa}     % nível acadêmico + nome
\local{Caicó- RN}
\data{\the\year}
\instituicao{
